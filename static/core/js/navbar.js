/* <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #424242;">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="index.html" style="color: #e0e0e0; font-weight: bold;"><h4>Home</h4></a>
        </li>
      </ul>
      <form class="d-flex" action="search.html" method="GET" style="margin-top: 15px;">
        <input class="form-control me-2" name="query" type="search" placeholder="Search" aria-label="Search" style="background-color: #1d1c1c;color: #e0e0e0;">
          <button class="btn btn-outline-success" type="submit" style="background-color: #00897B; color: #e0e0e0; font-weight: 900;">Search</button>
    </form>
  </div>
    </div>
</nav> */
...
nav.setAttribute("style", "background-color: #424242;");
...
brand_a.innerHTML = "<h4 style='color:#e0e0e0;'>Home</h4>";
...
button1.setAttribute("color", "#e0e0e0");
...
a1.setAttribute("style", "color: #e0e0e0; font-weight: bold;");
...
input1.setAttribute("style", "background-color: #1d1c1c;color: #e0e0e0;");

form.appendChild(input1);

let form_button = document.createElement("button");
form_button.setAttribute("class", "btn btn-outline-success");
form_button.setAttribute("type", "submit");
form_button.setAttribute("style", "background-color: #00897B; color: #e0e0e0; font-weight: 900;");
